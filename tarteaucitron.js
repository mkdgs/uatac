var tarteaucitron = (function () {
  ...
  let t = {
    ...
    eventListeners: ["load", "scroll", "keydown", "hashchange", "resize"],
    init: function (params) {
      ...
      // Step 0: set params
      t.parameters = t.defaults;
      if (params !== undefined) {
        for (var k in t.defaults) {
          if (params.hasOwnProperty(k)) {
            t.parameters[k] = params[k];
          }
        }
      }

      t.language = t.getLanguage();
      t.useJSDelivrMinifiedJS = t.cdn.indexOf("cdn.jsdelivr.net") >= 0;
      t.pathToLang =
        t.cdn +
        "lang/tarteaucitron." +
        t.language +
        (t.useJSDelivrMinifiedJS ? ".min" : "") +
        ".js?v=" +
        t.version;
      t.pathToServices =
        t.cdn +
        ...
        ".js?v=" +
        t.version;
      if (!t.parameters.servicesJs) {
        t.servicesJs = t.pathToServices;
      } else {
        t.servicesJs = t.parameters.servicesJs;
      }
    ...
    initEvents: {
      ...
      hashchangeEvent: function () {
        if (document.location.hash === t.hashtag && t.hashtag !== "") {
          t.userInterface.openPanel();
        }
      },
    ...
    load: function () {
      ...
      t.handleBrowserDNTRequest = t.parameters.handleBrowserDNTRequest;
      ...
      let cssUrl =
        ...
        ".css?v=" +
        t.version;
      if (!t.parameters.useExternalCss === true) {
        cssUrl = false;
      } else if (t.parameters.useExternalCss) {
        cssUrl = t.parameters.useExternalCss;
      }
      if (cssUrl) {
      ...
      t.addScript(t.pathToLang, "", function () {
        if (tarteaucitronCustomText !== "") {
          t.lang = t.AddOrUpdate(t.lang, tarteaucitronCustomText);
        }
        t.loadHtml();
      });
    },
    loadHtml: function () {
      t.addServicesScript(function () {
        ...
        if (t.parameters.highPrivacy && !t.parameters.AcceptAllCta) {
          html +=
          ...
          if (t.parameters.highPrivacy) {
            ...
            html += "       " + t.lang.alertBigClick + " " + t.lang.alertBig;
          }
        ...
        t.addInternalScript(
          ...
          function () {
            if (
              ...
              div.setAttribute("lang", t.language);
        ...
        if (t.parameters.adblocker === true) {
          setTimeout(function () {
            if (tarteaucitronNoAdBlocker === false) {
              ...
              html += "       <strong>" + t.lang.adblock_call + "</strong>";
              html += "   </p>";
              html +=
          ...
          Array.prototype.forEach.call(cats, function (item) {
            ...
            if (cat !== "mandatory") {
              ...
              html +=
                ...
                t.lang[cat].title +
                "</span>";
              html += "       <span>" + t.lang[cat].details + "</span>";
              html +=
              ...
              t.addClickEventToId(
                ...
                function () {
                  t.userInterface.toggle("tarteaucitronServices_" + cat);
                  if (
                    document.getElementById("tarteaucitronServices_" + cat)
                      .style.display == "block"
                  ) {
        ...
        setTimeout(function () {
          // Setup events
          t.addClickEventToId("tarteaucitronCloseCross", function () {
            t.userInterface.closeAlert();
          });
          t.addClickEventToId("tarteaucitronPersonalize", function () {
            t.userInterface.openPanel();
          });
          t.addClickEventToId("tarteaucitronPersonalize2", function () {
            t.userInterface.respondAll(true);
          });
          t.addClickEventToId("tarteaucitronManager", function () {
            t.userInterface.openPanel();
          });
          t.addClickEventToId("tarteaucitronBack", function () {
            t.userInterface.closePanel();
          });
          t.addClickEventToId("tarteaucitronClosePanel", function () {
            t.userInterface.closePanel();
          });
          t.addClickEventToId("tarteaucitronClosePanelCookie", function () {
            t.userInterface.closePanel();
          });
          t.addClickEventToId("tarteaucitronPrivacyUrl", function () {
            document.location = t.parameters.privacyUrl;
          });
          t.addClickEventToId("tarteaucitronPrivacyUrlDialog", function () {
            document.location = t.parameters.privacyUrl;
          });
          t.addClickEventToId("tarteaucitronCookiesNumber", function () {
            t.userInterface.toggleCookiesList();
          });
          t.addClickEventToId("tarteaucitronAllAllowed", function () {
            t.userInterface.respondAll(true);
          });
          t.addClickEventToId("tarteaucitronAllDenied", function () {
            t.userInterface.respondAll(false);
          });
          t.addClickEventToId("tarteaucitronAllDenied2", function () {
            t.userInterface.respondAll(false, "", true);
            if (t.reloadThePage === true) {
              window.location.reload();
            }
          });
          t.addClickEventToId("tarteaucitronCloseAlert", function () {
            t.userInterface.openPanel();
          });
          t.addClickEventToId("tarteaucitronCTAButton", function () {
            location.reload();
          });
    ...
    addService: function (serviceId) {
      ...
      var html = "",
        ...
        isDNTRequested =
          ...
          window.doNotTrack === "1",
        currentStatus = isAllowed ? t.lang.allowed : t.lang.disallowed,
        state =
      ...
      if (t.added[service.key] !== true) {
        ...
        html += `<li id="${service.key}Line" class="tarteaucitronLine">
                    <div class="tarteaucitronName">
                        ...
                        <span class="tacCurrentStatus" id="tacCurrentStatus${service.key}">${currentStatus}</span>
                        <span class="tarteaucitronReadmoreSeparator"> - </span>
                        <span id="tacCL${service.key}" class="tarteaucitronListCookies"></span><br/>`;
        if (service.readmoreLink) {
          html += `<a href="${service.readmoreLink}" target="_blank" rel="noreferrer noopener nofollow" 
                      title="${t.lang.more} : ${t.lang.cookieDetail$} ${service.name} ${t.lang.ourSite} ${t.lang.newWindow}" 
                      class="tarteaucitronReadmoreInfo">${t.lang.more}</a>`;
        }

        html += `</div>
                <div class="tarteaucitronAsk">
                    <button type="button" aria-label="${t.lang.allow} ${service.name}" 
                    id="${service.key}Allowed" class="tarteaucitronAllow">
                    <span class="tarteaucitronCheck" aria-hidden="true"></span> 
                    ${t.lang.allow}</button>
                    <button type="button" aria-label="${t.lang.deny} ${service.name}" 
                    id="${service.key}Denied" class="tarteaucitronDeny">
                    <span class="tarteaucitronCross" aria-hidden="true"></span> 
                    ${t.lang.deny}</button>
                </div>";
            </li>`;
        ...
        t.userInterface.css("tarteaucitronNoServicesTitle", "display", "none");
      ...
      } else if (!isResponded && isDNTRequested && t.handleBrowserDNTRequest) {
    ...
    userInterface: {
      ...
      color: function (key, status) {
        ...
        if (key !== "") {
          if (status === true) {
            t.userInterface.addClass(key + "Line", "tarteaucitronIsAllowed");
            t.userInterface.removeClass(key + "Line", "tarteaucitronIsDenied");
            document
            ...
            t.userInterface.removeClass(key + "Line", "tarteaucitronIsAllowed");
            t.userInterface.addClass(key + "Line", "tarteaucitronIsDenied");
            document
              .getElementById(key + "Allowed")
              .setAttribute("aria-pressed", "false");
            document
          ...
          for (index = 0; index < sum; index += 1) {
            ...
            if (t.state[t.job[index]] === false) {
              nbDenied += 1;
            } else if (t.state[t.job[index]] === undefined) {
              nbPending += 1;
          ...
          if (nbDenied === 0 && nbPending === 0) {
            t.userInterface.removeClass(c + "AllDenied", c + "IsSelected");
            t.userInterface.addClass(c + "AllAllowed", c + "IsSelected");

            t.userInterface.addClass(c + "MainLineOffset", c + "IsAllowed");
            t.userInterface.removeClass(c + "MainLineOffset", c + "IsDenied");
            ...
            t.userInterface.removeClass(c + "AllAllowed", c + "IsSelected");
            t.userInterface.addClass(c + "AllDenied", c + "IsSelected");

            t.userInterface.removeClass(c + "MainLineOffset", c + "IsAllowed");
            t.userInterface.addClass(c + "MainLineOffset", c + "IsDenied");
          ...
          if (t.services[key].cookies.length > 0 && status === false) {
      ...
      openPanel: function () {
        ...
        t.userInterface.css("tarteaucitronBack", "display", "block");
        t.userInterface.css(
          "tarteaucitronCookiesListContainer",
          "display",
          "none"
      ...
      closePanel: function () {
        ...
        if (t.checkIfExist("tarteaucitron")) {
          ...
          } else if (t.customCloserId && t.checkIfExist(t.customCloserId)) {
        ...
        if (t.reloadThePage === true) {
          ...
          t.userInterface.css("tarteaucitronBack", "display", "none");
        }
        if (document.getElementsByTagName("body")[0].classList !== undefined) {
          document
            .getElementsByTagName("body")[0]
      ...
      openAlert: function () {
        ...
        t.userInterface.addClass(c + "Root", "tarteaucitronBeforeVisible");
      ...
      closeAlert: function () {
        ...
        t.userInterface.removeClass(c + "Root", "tarteaucitronBeforeVisible");
      ...
      jsSizing: function (type) {
        ...
        if (type === "box") {
          ...
          if (
            ...
            // reset
            t.userInterface.css("tarteaucitronServices", "height", "auto");
            ...
            t.userInterface.css("tarteaucitronServices", "overflow-x", "auto");
          }
          ...
          if (document.getElementById("tarteaucitron") !== null) {
            ...
            // apply
            t.userInterface.css("tarteaucitron", "top", mainTop + "px");
          }
        } else if (type === "cookie") {
          ...
          if (
            ...
            // reset
            t.userInterface.css("tarteaucitronCookiesList", "height", "auto");
    ...
    cookie: {
      ...
      create: function (key, status) {
        ...
        var d = new Date(),
          ...
          value =
            t.parameters.cookieName + "=" + cookie + "!" + key + "=" + status,
          domain =
          ...
          for (i = 0; i < nb; i += 1) {
            if (document.cookie.indexOf(arr[i] + "=") !== -1) {
              ...
              if (
                ...
                t.cookie.owner[arr[i]].push(t.services[key].name);
              }
            }
          }

          if (nbCurrent > 0) {
            html += t.lang.useCookieCurrent + " " + nbCurrent + " cookie";
            if (nbCurrent > 1) {
              html += "s";
            }
            html += ".";
      ...
      number: function () {
        ...
        var cookies = document.cookie.split(";"),
          ...
          regex = /^https?\:\/\/([^\/?#]+)(?:[\/?#]|$)/i,
          regexedDomain =
            t.cdn.match(regex) !== null ? t.cdn.match(regex)[1] : t.cdn,
          host = t.domain !== undefined ? t.domain : regexedDomain;

        cookies = cookies.sort(function (a, b) {
          namea = a.split("=", 1).toString().replace(/ /g, "");
          nameb = b.split("=", 1).toString().replace(/ /g, "");
          c = t.cookie.owner[namea] !== undefined ? t.cookie.owner[namea] : "0";
          d = t.cookie.owner[nameb] !== undefined ? t.cookie.owner[nameb] : "0";
          if (c + a > d + b) {
            return 1;
          }
          if (c + a < d + b) {
        ...
        if (document.cookie !== "") {
          for (i = 0; i < nb; i += 1) {
            ...
            html +=
              ...
              t.fixSelfXSS(cookies[i].split("=").slice(1).join("=")) +
              "</div>";
            html += "</li>";
          }
          html += "</ul>";
    ...
    addServicesScript: function (callback, execute, attrName, attrVal) {
      let id = "";
      if (t.servicesJs !== false) {
        t.addScript(t.servicesJs, id, callback, execute, attrName, attrVal);
      } else {
        // fix todo remove it
        callback();
      }
      ...
      execJS: function (id) {
        ...
        for (i = 0; i < scripts.length; i += 1) {
          ...
          if (
            ...
            document.getElementById(id).innerHTML +=
              '<div id="' + childId + '"></div>';
            t.makeAsync.getAndParse(scripts[i].getAttribute("src"), childId);
    ...
    engage: function (id) {
      ...
      var html = "",
        ...
        engage = t.services[id].name + " " + t.lang.fallback;
    ...
    addClickEventToId: function (elemId, func) {
      t.addClickEventToElement(document.getElementById(elemId), func);
    },
